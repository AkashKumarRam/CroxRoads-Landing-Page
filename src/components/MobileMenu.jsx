...
function MobileMenu() {
  ...
  return (
    <div className="relative sm:hidden w-full pl-4 pr-4 mt-2 bg-[#F5F0F8]">
      ...
      {isOpen && (
        <div className="absolute left-0 ml-5 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
          <div
            className="py-2 px-3"
            role="menu"
          ...
          >
            ...
            {/* <button
              ...
              className="block px-4 py-2 mt-2 text-sm font-medium border-[#2F3FD4] rounded-md border-2 p-2 bg-[#2F3FD4] text-white w-28"
            >
              Request for Beta
            </button> */}
          </div>
